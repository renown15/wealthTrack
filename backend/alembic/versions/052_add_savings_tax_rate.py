"""Add savings_tax_rate reference data (highest-rate tax on savings interest).
...
_CLASS_KEY = "savings_tax_rate"
_RATE = "45"  # highest UK income-tax band; edit here or via the ReferenceData admin
